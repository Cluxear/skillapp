...
public class SkillResourceIT {
    ...
    public void createSkill() throws Exception {
        ...
        restSkillMockMvc.perform(post("/api/skills").with(csrf())
    ...
    public void updateSkill() throws Exception {
        ...
        restSkillMockMvc.perform(put("/api/skills").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(skillDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteSkill() throws Exception {
        ...
        // Delete the skill
        restSkillMockMvc.perform(delete("/api/skills/{id}", skill.getId()).with(csrf())
